...
We have prepared the data into [cstidy format](https://csids.no/cstidy/articles/csfmt_rts_data_v1.html), from which we can see the summary of each column, such as data type and amount of missing data. 
