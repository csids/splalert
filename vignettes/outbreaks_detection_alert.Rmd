...
```{r}
out_farringtonflex <- csalert::farrington_algorithm_create_alerts(baseline_with_seasonal_spike_holiday,
...
```{r}
out_sykdomspulsen <- csalert::farrington_algorithm_create_alerts(baseline_with_seasonal_spike_holiday,
                                                  b = 5,
                                                  offset = F,
                                                  reweights = 1,
                                                  remove.highcounts = 0,
